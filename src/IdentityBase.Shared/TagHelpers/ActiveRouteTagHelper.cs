    ...
    public class ActiveRouteTagHelper : TagHelper
    {
        ...
        public IDictionary<string, string> RouteValues
        {
            get
            {
                ...
                {
                    this._routeValues = new Dictionary<string, string>(
        ...
        {
            RouteValueDictionary values = this.ViewContext.RouteData.Values;

            string currentController = values["Controller"].ToString();
            string currentAction = values["Action"].ToString();
            ...
            {
                if (!values.ContainsKey(routeValue.Key) ||
                    values[routeValue.Key].ToString() != routeValue.Value)
                {
                    return false;
                }
            }
